...
export type UserWithProfiles = User & {
  jobSeeker: Pick<JobSeeker, 'id' | 'fullName' | 'portfolioUrl' | 'experienceSummary'> | null;
  company: Pick<Company, 'id' | 'companyName' | 'websiteUrl' | 'description'> | null;
};
...
export interface UserManagementRepository {
  ...
  createJobSeekerProfile(userId: string, data: CreateJobSeekerProfileData): Promise<JobSeeker>;
  createCompanyProfile(userId: string, data: CreateCompanyProfileData): Promise<Company>;
  ...
  updateJobSeekerProfile(userId: string, data: UpdateJobSeekerProfileData): Promise<JobSeeker>;
  updateCompanyProfile(userId: string, data: UpdateCompanyProfileData): Promise<Company>;
}
