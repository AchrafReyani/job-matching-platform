...
describe("NotificationsController", () => {
  ...
  let _getNotificationsUseCase: GetNotificationsUseCase;
  let _getUnreadCountUseCase: GetUnreadCountUseCase;
  let _markNotificationReadUseCase: MarkNotificationReadUseCase;
  let _markAllNotificationsReadUseCase: MarkAllNotificationsReadUseCase;
  ...
  beforeEach(async () => {
      ...
      providers: [
        {
          ...
          useValue: mockGetNotificationsUseCase,
        },
    ...
    _getNotificationsUseCase = module.get<GetNotificationsUseCase>(
      GetNotificationsUseCase,
    );
    _getUnreadCountUseCase = module.get<GetUnreadCountUseCase>(
      GetUnreadCountUseCase,
    );
    _markNotificationReadUseCase = module.get<MarkNotificationReadUseCase>(
      MarkNotificationReadUseCase,
    );
    _markAllNotificationsReadUseCase =
      module.get<MarkAllNotificationsReadUseCase>(
  ...
  describe("markAllAsRead", () => {
    it("should mark all notifications as read", async () => {
      mockMarkAllNotificationsReadUseCase.execute.mockResolvedValue({
        markedCount: 3,
      });
      ...
      expect(mockMarkAllNotificationsReadUseCase.execute).toHaveBeenCalledWith(
        "user-1",
      );
