...
describe('AccountController', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        { provide: GetNotificationPreferencesUseCase, useValue: mockGetNotificationPreferencesUseCase },
        { provide: UpdateNotificationPreferencesUseCase, useValue: mockUpdateNotificationPreferencesUseCase },
    ...
    getNotificationPreferencesUseCase = module.get(GetNotificationPreferencesUseCase);
    updateNotificationPreferencesUseCase = module.get(UpdateNotificationPreferencesUseCase);
  ...
  describe('getNotificationPreferences', () => {
    it('should return notification preferences', async () => {
      ...
      const result = await controller.getNotificationPreferences(mockRequest as never);

      expect(result).toEqual(mockPrefs);
      expect(getNotificationPreferencesUseCase.execute).toHaveBeenCalledWith('user-123');
    });
  });
  ...
  describe('updateNotificationPreferences', () => {
    it('should update and return notification preferences', async () => {
      ...
      updateNotificationPreferencesUseCase.execute.mockResolvedValue(updatedPrefs);
