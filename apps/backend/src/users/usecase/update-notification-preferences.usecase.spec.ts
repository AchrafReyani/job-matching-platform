...
describe('UpdateNotificationPreferencesUseCase', () => {
  ...
  it('should update notification preferences and return updated preferences', async () => {
    ...
    mockUserRepository.updateNotificationPreferences.mockResolvedValue(undefined);
    mockUserRepository.getNotificationPreferences.mockResolvedValue(updatedPrefs);
    ...
    expect(mockUserRepository.getNotificationPreferences).toHaveBeenCalledWith('user-123');
  });
