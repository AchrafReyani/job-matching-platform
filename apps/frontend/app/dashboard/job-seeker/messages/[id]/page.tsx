...
export default function JobSeekerChatPage() {
  ...
  if (error)
    return <div className="text-[var(--color-error-dark)] text-center mt-10">{error}</div>;
        ...
        <div className="flex flex-col items-center mb-4">
          ...
          {companyUserId && (
            <div className="mt-3">
              <Button
                variant="outline"
                className="border-[var(--color-muted)] text-[var(--color-text)] hover:bg-[var(--color-secondary-dark)]"
